...
#USE_FP16 = hyper_parameters.USE_FP16
...
#MOVING_AVERAGE_DECAY = hyper_parameters.MOVING_AVERAGE_DECAY  # The decay to use for the moving average.
#NUM_EPOCHS_PER_DECAY = hyper_parameters.NUM_EPOCHS_PER_DECAY  # Epochs after which learning rate decays.
#LEARNING_RATE_DECAY_FACTOR = hyper_parameters.LEARNING_RATE_DECAY_FACTOR  # Learning rate decay factor.
#INITIAL_LEARNING_RATE = hyper_parameters.INITIAL_LEARNING_RATE  # Initial learning rate.


# If a model is trained with multiple GPUs, prefix all Op names with tower_name
# to differentiate the operations. Note that this prefix is removed from the
# names of the summaries when visualizing a model.
#TOWER_NAME = hyper_parameters.TOWER_NAME
